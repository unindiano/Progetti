...
LIST.SubItems(13) = RS!STELLE
LIST.SubItems(13) = RS!STANZE
RS.MoveNext
Loop
End Sub
Sub PULISCI()
...
RS("STELLE") = TXTSTELLE.Text
RS("STANZE") = TXTST.Text
End Sub
...
Set RS = DB.OpenRecordset("T_HOTEL", dbOpenDynaset)
...
If A = 0 Then
    If FRMHOTEL.Height > 4400 Then
        FRMHOTEL.Height = 4890
    Else
        FRMHOTEL.Height = FRMHOTEL.Height + 200
        FRMHOTEL.Top = FRMHOTEL.Top - 200

    End If
ElseIf A = 1 Then
    If FRMHOTEL.Height < 100 Then
        Unload Me
    Else
        FRMHOTEL.Height = FRMHOTEL.Height - 200
        FRMHOTEL.Top = FRMHOTEL.Top + 200
