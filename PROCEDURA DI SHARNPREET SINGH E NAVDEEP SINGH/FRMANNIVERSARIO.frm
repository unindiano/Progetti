...
Begin VB.Form FRMANNIVERSARIO 
   ...
   Begin VB.Frame FMESUPPORTO 
      ...
      Begin VB.ComboBox CBOGGC 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "FRMANNIVERSARIO.frx":0000
         Left            =   120
         List            =   "FRMANNIVERSARIO.frx":0002
         TabIndex        =   15
         Text            =   "GG"
         Top             =   1680
         Width           =   615
   ...
   End
End
Attribute VB_Name = "FRMANNIVERSARIO"
...
If TXTN.Text <> "" And TXTTA.Text <> "" And TXTC.Text <> "" Then
RS.AddNew
TRASFERISCI
RS.Update
PULISCI
...
RS("T_A") = TXTTA.Text
RS("C_A") = TXTC.Text
RS("DATA_A") = CBOGGC.Text + "/" + CBOMMC.Text + "/" + CBOYYC.Text
End Sub

Private Sub CMDMODIFICA_Click()
C = MsgBox("SEI SICURO DI VOLER MODIFICARE IL RECORD", vbYesNo)
If C = 6 Then
    ricercamodifica = "N_A='" & TXTN.Text & "'"
...
Timer1.Enabled = True
FRMANNIVERSARIO.Top = 8000
FRMANNIVERSARIO.Height = 0
A = 0
CARICADATA
Set DB = Workspaces(0).OpenDatabase(App.Path + "\DATABASE")
Set RS = DB.OpenRecordset("T_ANNIVERSARIO", dbOpenDynaset)
...
If A = 0 Then
    If FRMANNIVERSARIO.Height > 4400 Then
        FRMANNIVERSARIO.Height = 4890
    Else
        FRMANNIVERSARIO.Height = FRMANNIVERSARIO.Height + 200
        FRMANNIVERSARIO.Top = FRMANNIVERSARIO.Top - 200

    End If
ElseIf A = 1 Then
    If FRMANNIVERSARIO.Height < 100 Then
