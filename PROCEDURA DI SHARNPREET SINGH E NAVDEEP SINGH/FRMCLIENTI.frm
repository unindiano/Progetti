...
Begin VB.Form FRMCLIENTI 
   ...
   Begin VB.Frame FMESUPPORTO 
      ...
      Begin VB.ComboBox CBOGGC 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "FRMCLIENTI.frx":0000
         Left            =   4800
         List            =   "FRMCLIENTI.frx":0002
         TabIndex        =   5
         Text            =   "GG"
         Top             =   840
         Width           =   615
...
Set RS = DB.OpenRecordset("T_CLIENTI", dbOpenDynaset)
...
If A = 0 Then
    If FRMCLIENTI.Height > 4400 Then
        FRMCLIENTI.Height = 4890
    Else
        FRMCLIENTI.Height = FRMCLIENTI.Height + 200
        FRMCLIENTI.Top = FRMCLIENTI.Top - 200

    End If
ElseIf A = 1 Then
    If FRMCLIENTI.Height < 100 Then
        Unload Me
    Else
        FRMCLIENTI.Height = FRMCLIENTI.Height - 200
        FRMCLIENTI.Top = FRMCLIENTI.Top + 200
