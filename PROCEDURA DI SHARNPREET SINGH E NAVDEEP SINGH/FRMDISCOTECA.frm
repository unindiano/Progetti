...
Begin VB.Form FRMDISCOTECA 
   ...
   End
End
Attribute VB_Name = "FRMDISCOTECA"
...
Timer1.Enabled = True
FRMDISCOTECA.Top = 8000
FRMDISCOTECA.Height = 0
A = 0

Set DB = Workspaces(0).OpenDatabase(App.Path + "\DATABASE")
Set RS = DB.OpenRecordset("T_DISCOTECA", dbOpenDynaset)
...
If A = 0 Then
    If FRMDISCOTECA.Height > 4400 Then
        FRMDISCOTECA.Height = 4890
    Else
        FRMDISCOTECA.Height = FRMDISCOTECA.Height + 200
        FRMDISCOTECA.Top = FRMDISCOTECA.Top - 200

    End If
ElseIf A = 1 Then
    If FRMDISCOTECA.Height < 100 Then
