...
Set RS = DB.OpenRecordset("T_BAR", dbOpenDynaset)
...
If A = 0 Then
    If FRMBAR.Height > 4400 Then
        FRMBAR.Height = 4890
    Else
        FRMBAR.Height = FRMBAR.Height + 200
        FRMBAR.Top = FRMBAR.Top - 200

    End If
ElseIf A = 1 Then
    If FRMBAR.Height < 100 Then
