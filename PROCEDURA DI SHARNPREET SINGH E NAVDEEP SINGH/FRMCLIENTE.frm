...
LIST.SubItems(13) = RS!T_FORNITURA
RS.MoveNext
Loop
End Sub
Sub PULISCI()
...
Timer1.Enabled = True
FRMFORNITORI.Top = 8000
FRMFORNITORI.Height = 0
A = 0

Set DB = Workspaces(0).OpenDatabase(App.Path + "\DATABASE")
Set RS = DB.OpenRecordset("T_FORNITORI", dbOpenDynaset)
...
If A = 0 Then
    If FRMFORNITORI.Height > 4400 Then
        FRMFORNITORI.Height = 4890
    Else
        FRMFORNITORI.Height = FRMFORNITORI.Height + 200
        FRMFORNITORI.Top = FRMFORNITORI.Top - 200

    End If
ElseIf A = 1 Then
    If FRMFORNITORI.Height < 100 Then
